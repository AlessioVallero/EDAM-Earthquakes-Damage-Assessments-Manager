...
model = Alloy.M("ShedFormsDamages", exports.definition, [ function(migration) {
    migration.name = "ShedFormsDamages";
...
collection = Alloy.C("ShedFormsDamages", exports.definition, model);
