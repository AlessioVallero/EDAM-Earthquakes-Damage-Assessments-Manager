...
function Controller() {
    ...
    $.__views.baeaModeFormsLiquefactionWindow && $.addTopLevelView($.__views.baeaModeFormsLiquefactionWindow);
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsLiquefactionWindow.addEventListener("android:back", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsLiquefactionWindow!android:back!OnAndroidBackButton_Click"] = true;
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsLiquefactionWindow.addEventListener("androidback", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsLiquefactionWindow!androidback!OnAndroidBackButton_Click"] = true;
    ...
    $.__views.__alloyId54.add($.__views.lblPhoto);
    ...
    __defers["$.__views.baeaModeFormsLiquefactionWindow!android:back!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsLiquefactionWindow.addEventListener("android:back", OnAndroidBackButton_Click);
    __defers["$.__views.baeaModeFormsLiquefactionWindow!androidback!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsLiquefactionWindow.addEventListener("androidback", OnAndroidBackButton_Click);
