...
function Controller() {
    ...
    $.__views.baeaModeFormsFaultRuptureWindow && $.addTopLevelView($.__views.baeaModeFormsFaultRuptureWindow);
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsFaultRuptureWindow.addEventListener("android:back", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsFaultRuptureWindow!android:back!OnAndroidBackButton_Click"] = true;
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsFaultRuptureWindow.addEventListener("androidback", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsFaultRuptureWindow!androidback!OnAndroidBackButton_Click"] = true;
    ...
    $.__views.__alloyId35.add($.__views.lblPhoto);
    ...
    $.__views.__alloyId37.add($.__views.lblOffsetFeatureType);
    ...
    __defers["$.__views.baeaModeFormsFaultRuptureWindow!android:back!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsFaultRuptureWindow.addEventListener("android:back", OnAndroidBackButton_Click);
    __defers["$.__views.baeaModeFormsFaultRuptureWindow!androidback!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsFaultRuptureWindow.addEventListener("androidback", OnAndroidBackButton_Click);
