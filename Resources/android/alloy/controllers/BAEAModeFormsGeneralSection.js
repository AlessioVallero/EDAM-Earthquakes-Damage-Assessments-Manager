...
function Controller() {
    ...
    $.__views.baeaModeFormsGeneralSectionWindow && $.addTopLevelView($.__views.baeaModeFormsGeneralSectionWindow);
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsGeneralSectionWindow.addEventListener("android:back", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsGeneralSectionWindow!android:back!OnAndroidBackButton_Click"] = true;
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsGeneralSectionWindow.addEventListener("androidback", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsGeneralSectionWindow!androidback!OnAndroidBackButton_Click"] = true;
    ...
    __defers["$.__views.baeaModeFormsGeneralSectionWindow!android:back!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsGeneralSectionWindow.addEventListener("android:back", OnAndroidBackButton_Click);
    __defers["$.__views.baeaModeFormsGeneralSectionWindow!androidback!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsGeneralSectionWindow.addEventListener("androidback", OnAndroidBackButton_Click);
