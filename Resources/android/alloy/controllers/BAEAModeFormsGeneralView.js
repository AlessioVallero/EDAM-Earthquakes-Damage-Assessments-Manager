...
function Controller() {
    ...
    $.__views.baeaModeFormsGeneralWindow && $.addTopLevelView($.__views.baeaModeFormsGeneralWindow);
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsGeneralWindow.addEventListener("android:back", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsGeneralWindow!android:back!OnAndroidBackButton_Click"] = true;
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsGeneralWindow.addEventListener("androidback", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsGeneralWindow!androidback!OnAndroidBackButton_Click"] = true;
    ...
    $.__views.__alloyId39.add($.__views.lblPhoto);
    ...
    __defers["$.__views.baeaModeFormsGeneralWindow!android:back!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsGeneralWindow.addEventListener("android:back", OnAndroidBackButton_Click);
    __defers["$.__views.baeaModeFormsGeneralWindow!androidback!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsGeneralWindow.addEventListener("androidback", OnAndroidBackButton_Click);
