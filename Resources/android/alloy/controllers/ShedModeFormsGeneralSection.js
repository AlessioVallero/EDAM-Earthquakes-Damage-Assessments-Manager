...
function Controller() {
    ...
    function UpdateVideoPosition(e) {
        try {
            ...
            } else Alloy.Globals.reverseGeocodeAndUseCamera(sCurrentHeading, e.coords.latitude, e.coords.longitude, $.shedModeFormsGeneralSectionWindow.getActivity(), RaiseEndAsyncBusyAction_CallBack);
        } catch (exception) {
            Alloy.Globals.AlertUserAndLogAsync(L("generic_exception_msg") + exception.message);
        }
    }
