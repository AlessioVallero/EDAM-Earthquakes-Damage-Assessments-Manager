...
function Controller() {
    ...
    $.__views.singlePictureViewWindow && $.addTopLevelView($.__views.singlePictureViewWindow);
    ...
    __alloyId74.push($.__views.viewImageView);
    ...
    __alloyId74.push($.__views.viewData);
