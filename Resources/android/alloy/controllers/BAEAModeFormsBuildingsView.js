...
function Controller() {
    ...
    $.__views.baeaModeFormsBuildingsWindow && $.addTopLevelView($.__views.baeaModeFormsBuildingsWindow);
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsBuildingsWindow.addEventListener("android:back", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsBuildingsWindow!android:back!OnAndroidBackButton_Click"] = true;
    OnAndroidBackButton_Click ? $.__views.baeaModeFormsBuildingsWindow.addEventListener("androidback", OnAndroidBackButton_Click) : __defers["$.__views.baeaModeFormsBuildingsWindow!androidback!OnAndroidBackButton_Click"] = true;
    ...
    $.__views.__alloyId33.add($.__views.lblPhoto);
    ...
    __defers["$.__views.baeaModeFormsBuildingsWindow!android:back!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsBuildingsWindow.addEventListener("android:back", OnAndroidBackButton_Click);
    __defers["$.__views.baeaModeFormsBuildingsWindow!androidback!OnAndroidBackButton_Click"] && $.__views.baeaModeFormsBuildingsWindow.addEventListener("androidback", OnAndroidBackButton_Click);
