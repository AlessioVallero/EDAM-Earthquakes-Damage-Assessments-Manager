...
function Controller() {
    function __alloyId67(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId62 = Ti.UI.createTableViewRow({
                hasChild: "true",
                rowId: "undefined" != typeof __alloyId61.__transform["ID"] ? __alloyId61.__transform["ID"] : __alloyId61.get("ID"),
                isSynchronized: "undefined" != typeof __alloyId61.__transform["SYNCHRONIZED"] ? __alloyId61.__transform["SYNCHRONIZED"] : __alloyId61.get("SYNCHRONIZED"),
                className: "form_row"
            });
            rows.push(__alloyId62);
            var __alloyId63 = Ti.UI.createImageView({
                left: 5,
                width: 34,
                height: 34,
            ...
            var __alloyId64 = Ti.UI.createLabel({
                ...
                width: 200,
                color: "#000",
                text: "undefined" != typeof __alloyId61.__transform["FORM_NO"] ? __alloyId61.__transform["FORM_NO"] : __alloyId61.get("FORM_NO")
            });
            __alloyId62.add(__alloyId64);
            var __alloyId65 = Ti.UI.createButton({
                color: "black",
                backgroundColor: "red",
    ...
    $.__views.shedModeFormsWindow && $.addTopLevelView($.__views.shedModeFormsWindow);
    ...
    var __alloyId66 = Alloy.Collections["ShedForms"] || ShedForms;
