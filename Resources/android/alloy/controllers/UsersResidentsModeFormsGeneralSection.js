...
function Controller() {
    ...
    function UpdateVideoPosition(e) {
        try {
            ...
            } else Alloy.Globals.reverseGeocodeAndUseCamera(sCurrentHeading, e.coords.latitude, e.coords.longitude, $.usersResidentsModeFormsGeneralSectionWindow.getActivity(), RaiseEndAsyncBusyAction_CallBack);
        } catch (exception) {
            Alloy.Globals.AlertUserAndLogAsync(L("generic_exception_msg") + exception.message);
        }
    }
    ...
    $.__views.usersResidentsModeFormsGeneralSectionWindow && $.addTopLevelView($.__views.usersResidentsModeFormsGeneralSectionWindow);
    OnAndroidBackButton_Click ? $.__views.usersResidentsModeFormsGeneralSectionWindow.addEventListener("android:back", OnAndroidBackButton_Click) : __defers["$.__views.usersResidentsModeFormsGeneralSectionWindow!android:back!OnAndroidBackButton_Click"] = true;
    OnAndroidBackButton_Click ? $.__views.usersResidentsModeFormsGeneralSectionWindow.addEventListener("androidback", OnAndroidBackButton_Click) : __defers["$.__views.usersResidentsModeFormsGeneralSectionWindow!androidback!OnAndroidBackButton_Click"] = true;
    ...
    __defers["$.__views.usersResidentsModeFormsGeneralSectionWindow!android:back!OnAndroidBackButton_Click"] && $.__views.usersResidentsModeFormsGeneralSectionWindow.addEventListener("android:back", OnAndroidBackButton_Click);
    __defers["$.__views.usersResidentsModeFormsGeneralSectionWindow!androidback!OnAndroidBackButton_Click"] && $.__views.usersResidentsModeFormsGeneralSectionWindow.addEventListener("androidback", OnAndroidBackButton_Click);
