...
function Controller() {
    function __alloyId48(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId43 = Ti.UI.createTableViewRow({
                hasChild: "true",
                rowId: "undefined" != typeof __alloyId42.__transform["ID"] ? __alloyId42.__transform["ID"] : __alloyId42.get("ID"),
                isSynchronized: "undefined" != typeof __alloyId42.__transform["SYNCHRONIZED"] ? __alloyId42.__transform["SYNCHRONIZED"] : __alloyId42.get("SYNCHRONIZED"),
                className: "form_row"
            });
            rows.push(__alloyId43);
            var __alloyId44 = Ti.UI.createImageView({
                left: 5,
                width: 34,
                height: 34,
            ...
            var __alloyId45 = Ti.UI.createLabel({
                ...
                width: 200,
                color: "#000",
                text: "undefined" != typeof __alloyId42.__transform["FORM_NO"] ? __alloyId42.__transform["FORM_NO"] : __alloyId42.get("FORM_NO")
            });
            __alloyId43.add(__alloyId45);
            var __alloyId46 = Ti.UI.createButton({
                color: "black",
                backgroundColor: "red",
        ...
        try {
            ...
            Titanium.Network.networkType === Titanium.Network.NETWORK_NONE ? alert(L("generic_no_network_msg")) : BeginAsyncBusyAction($.activity_indicator, controls, function() {
                ...
                if (recoverDetails.length > 0) for (var i = 0; i < recoverDetails.length; i++) {
                    ...
                    uploadQueue.push({
                        content: params,
                        url: "https://areeweb.polito.it/IRUSAT/ReceiveUsersResidentsModeForm.php"
                    });
                }
                EndAsyncBusyAction($.activity_indicator, controls, EndAsyncBusyAction_CallBack);
    ...
    $.__views.usersResidentsModeFormsWindow && $.addTopLevelView($.__views.usersResidentsModeFormsWindow);
    ...
    var __alloyId47 = Alloy.Collections["UsersResidentsForms"] || UsersResidentsForms;
