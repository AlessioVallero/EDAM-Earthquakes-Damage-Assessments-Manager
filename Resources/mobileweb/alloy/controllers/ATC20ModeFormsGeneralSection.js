...
function Controller() {
        ...
        try {
            Titanium.Network.networkType === Titanium.Network.NETWORK_NONE ? alert(L("generic_no_network_msg")) : BeginAsyncBusyAction($.activity_indicator, controls, function() {
                ...
                if ("0" == current_atc20_type) {
                    ...
                    "CA" == current_mode ? loader.open("POST", "https://areeweb.polito.it/IRUSAT/ManipulatePDF/ATC20DetailedMode_ManipulatePDF.php") : "NZ" == current_mode && loader.open("POST", "https://areeweb.polito.it/IRUSAT/ManipulatePDF/ATC20NZLevel2Mode_ManipulatePDF.php");
                } else {
                    ...
                    "CA" == current_mode ? loader.open("POST", "https://areeweb.polito.it/IRUSAT/ManipulatePDF/ATC20RapidMode_ManipulatePDF.php") : "NZ" == current_mode && loader.open("POST", "https://areeweb.polito.it/IRUSAT/ManipulatePDF/ATC20NZLevel1Mode_ManipulatePDF.php");
                }
                loader.send(params);
                bRet = true;
                return bRet;
    ...
    try {
        "0" == current_atc20_type ? "CA" == current_mode ? $.atc20ModeFormsGeneralSectionWindow.setTitle(L("atc20_detailed_mode_forms_general_section_view_title")) : "NZ" == current_mode && $.atc20ModeFormsGeneralSectionWindow.setTitle(L("atc20_nz_detailed_mode_forms_general_section_view_title")) : "CA" == current_mode ? $.atc20ModeFormsGeneralSectionWindow.setTitle(L("atc20_rapid_mode_forms_general_section_view_title")) : "NZ" == current_mode && $.atc20ModeFormsGeneralSectionWindow.setTitle(L("atc20_nz_rapid_mode_forms_general_section_view_title"));
        "CA" == current_mode ? $.imageViewATC20Logo.setImage("/images/ATC20_logo.png") : "NZ" == current_mode && $.imageViewATC20Logo.setImage("/images/ATC20_NZ_logo.png");
