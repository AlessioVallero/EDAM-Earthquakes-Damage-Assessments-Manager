...
function Controller() {
    ...
    $.__views.usersResidentsModeFormsDetailsWindow.add($.__views.viewAppTextFieldUsersResidentsModeFormsDetailsFormNo);
    ...
    $.__views.usersResidentsModeFormsDetailsWindow.add($.__views.viewDate);
