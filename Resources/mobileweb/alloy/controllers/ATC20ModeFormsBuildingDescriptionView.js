...
function Controller() {
    ...
    $.__views.atc20ModeBuildingDescriptionWindow && $.addTopLevelView($.__views.atc20ModeBuildingDescriptionWindow);
    OnAndroidBackButton_Click ? $.__views.atc20ModeBuildingDescriptionWindow.addEventListener("android:back", OnAndroidBackButton_Click) : __defers["$.__views.atc20ModeBuildingDescriptionWindow!android:back!OnAndroidBackButton_Click"] = true;
    OnAndroidBackButton_Click ? $.__views.atc20ModeBuildingDescriptionWindow.addEventListener("androidback", OnAndroidBackButton_Click) : __defers["$.__views.atc20ModeBuildingDescriptionWindow!androidback!OnAndroidBackButton_Click"] = true;
    ...
    $.__views.viewAppTextFieldATC20ModeFormsBuildingDescriptioTypeOfConstructionOtherName = Ti.UI.createView({
        top: 1080,
        height: 50,
        width: Ti.UI.FILL,
        id: "viewAppTextFieldATC20ModeFormsBuildingDescriptioTypeOfConstructionOtherName"
    });
    $.__views.scrollViewBuildingDescription.add($.__views.viewAppTextFieldATC20ModeFormsBuildingDescriptioTypeOfConstructionOtherName);
    $.__views.widgetAppTextFieldATC20ModeFormsBuildingDescriptionTypeOfConstructionOtherName = Alloy.createWidget("com.diseg.AppTextField", "widget", {
        ...
        __parentSymbol: $.__views.viewAppTextFieldATC20ModeFormsBuildingDescriptioTypeOfConstructionOtherName
    });
    $.__views.widgetAppTextFieldATC20ModeFormsBuildingDescriptionTypeOfConstructionOtherName.setParent($.__views.viewAppTextFieldATC20ModeFormsBuildingDescriptioTypeOfConstructionOtherName);
    ...
    try {
        ...
        if ("CA" == current_mode) {
            wood_frame_msg = L("generic_type_of_construction_wood_frame");
            ...
            wood_frame_msg = L("generic_type_of_construction_timber_frame");
        ...
        if ("CA" == current_mode) {
            ...
            $.viewAppTextFieldATC20ModeFormsBuildingDescriptioTypeOfConstructionOtherName.setTop(730);
            ...
            $.viewAppTextFieldATC20ModeFormsBuildingDescriptioTypeOfConstructionOtherName.setTop(980);
    ...
    __defers["$.__views.atc20ModeBuildingDescriptionWindow!android:back!OnAndroidBackButton_Click"] && $.__views.atc20ModeBuildingDescriptionWindow.addEventListener("android:back", OnAndroidBackButton_Click);
    __defers["$.__views.atc20ModeBuildingDescriptionWindow!androidback!OnAndroidBackButton_Click"] && $.__views.atc20ModeBuildingDescriptionWindow.addEventListener("androidback", OnAndroidBackButton_Click);
