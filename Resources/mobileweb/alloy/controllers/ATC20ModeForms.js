        ...
        try {
            ...
            Titanium.Network.networkType === Titanium.Network.NETWORK_NONE ? alert(L("generic_no_network_msg")) : BeginAsyncBusyAction($.activity_indicator, controls, function() {
                ...
                if (recoverInspection.length > 0) for (var i = 0; i < recoverInspection.length; i++) {
                    ...
                    var uploadQueueURL = "https://areeweb.polito.it/IRUSAT/ReceiveATC20DetailedModeForm.php";
                    if ("0" == form_type) {
                        ...
                        uploadQueueURL = "https://areeweb.polito.it/IRUSAT/ReceiveATC20RapidModeForm.php";
    ...
    function OnBtnEditInspectorData_Click() {
        try {
            BusyAction($.activity_indicator, controls, function() {
                var bRet = false;
                bCanClickOnTableView = false;
                "CA" == current_mode ? Alloy.Globals.createAndOpenControllerExt("ATC20PersonalData") : "NZ" == current_mode && Alloy.Globals.createAndOpenControllerExt("ATC20NZPersonalData");
                bRet = true;
                return bRet;
            });
        } catch (exception) {
