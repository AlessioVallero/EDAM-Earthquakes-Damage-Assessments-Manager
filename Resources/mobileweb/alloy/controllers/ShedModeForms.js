...
function Controller() {
    function __alloyId31(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId26 = Ti.UI.createTableViewRow({
                hasChild: "true",
                rowId: "undefined" != typeof __alloyId25.__transform["ID"] ? __alloyId25.__transform["ID"] : __alloyId25.get("ID"),
                isSynchronized: "undefined" != typeof __alloyId25.__transform["SYNCHRONIZED"] ? __alloyId25.__transform["SYNCHRONIZED"] : __alloyId25.get("SYNCHRONIZED"),
                className: "form_row"
            });
            ...
            var __alloyId28 = Ti.UI.createLabel({
                ...
                width: 200,
                color: "#000",
                text: "undefined" != typeof __alloyId25.__transform["FORM_NO"] ? __alloyId25.__transform["FORM_NO"] : __alloyId25.get("FORM_NO")
            });
        ...
        try {
            ...
            Titanium.Network.networkType === Titanium.Network.NETWORK_NONE ? alert(L("generic_no_network_msg")) : BeginAsyncBusyAction($.activity_indicator, controls, function() {
                ...
                if (recoverDetails.length > 0) for (var i = 0; i < recoverDetails.length; i++) {
                    ...
                    uploadQueue.push({
                        content: params,
                        url: "https://areeweb.polito.it/IRUSAT/ReceiveShedModeForm.php"
                    });
                }
                EndAsyncBusyAction($.activity_indicator, controls, EndAsyncBusyAction_CallBack);
    ...
    var __alloyId30 = Alloy.Collections["ShedForms"] || ShedForms;
