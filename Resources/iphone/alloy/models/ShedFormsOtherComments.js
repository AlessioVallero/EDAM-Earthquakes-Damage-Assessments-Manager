...
model = Alloy.M("ShedFormsOtherComments", exports.definition, [ function(migration) {
    migration.name = "ShedFormsOtherComments";
...
collection = Alloy.C("ShedFormsOtherComments", exports.definition, model);
