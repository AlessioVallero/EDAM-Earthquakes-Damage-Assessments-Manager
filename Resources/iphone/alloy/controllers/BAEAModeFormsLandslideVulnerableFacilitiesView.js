...
function Controller() {
    ...
    $.__views.baeaModeLandslideVulnerableFacilitiesWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowLandslideVulnerableFacilities = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeLandslideVulnerableFacilitiesWindow,
        id: "navigationWindowLandslideVulnerableFacilities"
    });
    $.__views.navigationWindowLandslideVulnerableFacilities && $.addTopLevelView($.__views.navigationWindowLandslideVulnerableFacilities);
