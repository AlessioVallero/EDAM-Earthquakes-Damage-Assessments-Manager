...
function Controller() {
    ...
    $.__views.baeaModeFormsManageSectionViewWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowBAEAModeFormsManageSectionView = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeFormsManageSectionViewWindow,
        id: "navigationWindowBAEAModeFormsManageSectionView"
    });
    $.__views.navigationWindowBAEAModeFormsManageSectionView && $.addTopLevelView($.__views.navigationWindowBAEAModeFormsManageSectionView);
