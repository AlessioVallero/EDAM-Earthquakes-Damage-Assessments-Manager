...
function Controller() {
    function __alloyId38(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId33 = Ti.UI.createTableViewRow({
                hasChild: "true",
                rowId: "undefined" != typeof __alloyId31.__transform["ID"] ? __alloyId31.__transform["ID"] : __alloyId31.get("ID"),
                isSynchronized: "undefined" != typeof __alloyId31.__transform["SYNCHRONIZED"] ? __alloyId31.__transform["SYNCHRONIZED"] : __alloyId31.get("SYNCHRONIZED"),
                className: "form_row"
            });
            ...
            var __alloyId35 = Ti.UI.createLabel({
                ...
                width: 200,
                color: "#000",
                text: "undefined" != typeof __alloyId31.__transform["FORM_NO"] ? __alloyId31.__transform["FORM_NO"] : __alloyId31.get("FORM_NO")
            });
        ...
        try {
            ...
            Titanium.Network.networkType === Titanium.Network.NETWORK_NONE ? alert(L("generic_no_network_msg")) : BeginAsyncBusyAction($.activity_indicator, controls, function() {
                ...
                if (recoverDetails.length > 0) for (var i = 0; i < recoverDetails.length; i++) {
                    ...
                    uploadQueue.push({
                        content: params,
                        url: "https://www.edam.resiltronics.org/ReceiveAeDESModeForm.php"
                    });
                }
                EndAsyncBusyAction($.activity_indicator, controls, EndAsyncBusyAction_CallBack);
    ...
    $.__views.aedesModeFormsWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    var __alloyId37 = Alloy.Collections["AeDESForms"] || AeDESForms;
    ...
    $.__views.navigationWindowAeDESModeForms = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.aedesModeFormsWindow,
        id: "navigationWindowAeDESModeForms"
    });
    $.__views.navigationWindowAeDESModeForms && $.addTopLevelView($.__views.navigationWindowAeDESModeForms);
