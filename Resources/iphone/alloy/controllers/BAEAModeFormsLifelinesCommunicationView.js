...
function Controller() {
    ...
    $.__views.baeaModeLifelinesCommunicationWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowLifelinesCommunication = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeLifelinesCommunicationWindow,
        id: "navigationWindowLifelinesCommunication"
    });
    $.__views.navigationWindowLifelinesCommunication && $.addTopLevelView($.__views.navigationWindowLifelinesCommunication);
