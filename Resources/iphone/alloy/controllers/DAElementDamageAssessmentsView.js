...
function Controller() {
    ...
    $.__views.damageAssessmentsElemWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowDamageAssessmentsElem = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.damageAssessmentsElemWindow,
        id: "navigationWindowDamageAssessmentsElem"
    });
    $.__views.navigationWindowDamageAssessmentsElem && $.addTopLevelView($.__views.navigationWindowDamageAssessmentsElem);
