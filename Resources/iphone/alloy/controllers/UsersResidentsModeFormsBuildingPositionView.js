...
function Controller() {
    ...
    $.__views.usersResidentsModeFormsBuildingPositionWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.scrollViewBuildingPosition.add($.__views.viewAppButtonSave);
    ...
    $.__views.navigationWindowBuildingPosition = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.usersResidentsModeFormsBuildingPositionWindow,
        id: "navigationWindowBuildingPosition"
    });
    $.__views.navigationWindowBuildingPosition && $.addTopLevelView($.__views.navigationWindowBuildingPosition);
    ...
    try {
        ...
        RegisterHideKeyboard($.usersResidentsModeFormsBuildingPositionWindow, [ $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionLatitude.get_text_field(), $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionLongitude.get_text_field(), $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionAltitude.get_text_field(), $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionProvince.get_text_field(), $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionMunicipality.get_text_field(), $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionPlace.get_text_field(), $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionAddress.get_text_field(), $.widgetAppTextFieldUsersResidentsModeFormsBuildingPositionCivicNo.get_text_field() ]);
