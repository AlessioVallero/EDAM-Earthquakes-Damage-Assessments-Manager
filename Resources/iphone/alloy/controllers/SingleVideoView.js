...
function Controller() {
    ...
    $.__views.singleVideoViewWindow.leftNavButton = $.__views.btn_ios_back;
    var __alloyId167 = [];
    $.__views.viewVideoView = Ti.UI.createView({
        id: "viewVideoView"
    });
    __alloyId167.push($.__views.viewVideoView);
    $.__views.viewData = Ti.UI.createView({
        id: "viewData"
    });
    __alloyId167.push($.__views.viewData);
    ...
    $.__views.scrollViewSingleVideoView.add($.__views.btnExportToGallery);
    ...
    $.__views.navigationWindowSingleVideoView = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.singleVideoViewWindow,
        id: "navigationWindowSingleVideoView"
    });
    $.__views.navigationWindowSingleVideoView && $.addTopLevelView($.__views.navigationWindowSingleVideoView);
    ...
    try {
        ...
        RegisterHideKeyboard($.singleVideoViewWindow, [ $.widgetAppTextFieldLatitude.get_text_field(), $.widgetAppTextFieldLongitude.get_text_field(), $.widgetAppTextFieldAddress.get_text_field(), $.widgetAppTextFieldDamagesLevel.get_text_field(), $.widgetAppTextFieldDamagesArea.get_text_field(), $.widgetAppTextFieldComment.get_text_field() ]);
