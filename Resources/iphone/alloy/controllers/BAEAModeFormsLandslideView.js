...
function Controller() {
    ...
    $.__views.baeaModeFormsLandslideWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.__alloyId89.add($.__views.lblPhoto);
    ...
    $.__views.__alloyId91.add($.__views.lblLandslideType);
    $.__views.__alloyId92 = Ti.UI.createTableViewRow({
        hasChild: "true",
        className: "landslide_row",
        id: "__alloyId92"
    });
    __alloyId90.push($.__views.__alloyId92);
    ...
    $.__views.__alloyId92.add($.__views.lblMaterialType);
    ...
    $.__views.__alloyId93.add($.__views.lblAreaAffected);
    $.__views.__alloyId94 = Ti.UI.createTableViewRow({
        hasChild: "true",
        className: "landslide_row",
        id: "__alloyId94"
    });
    __alloyId90.push($.__views.__alloyId94);
    ...
    $.__views.__alloyId94.add($.__views.lblVulnerableFacilities);
    ...
    $.__views.navigationWindowLandslide = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeFormsLandslideWindow,
        id: "navigationWindowLandslide"
    });
    $.__views.navigationWindowLandslide && $.addTopLevelView($.__views.navigationWindowLandslide);
