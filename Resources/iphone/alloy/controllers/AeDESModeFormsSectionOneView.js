...
function Controller() {
    ...
    $.__views.aedesModeFormsSectionOneWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowSectionOne = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.aedesModeFormsSectionOneWindow,
        id: "navigationWindowSectionOne"
    });
    $.__views.navigationWindowSectionOne && $.addTopLevelView($.__views.navigationWindowSectionOne);
