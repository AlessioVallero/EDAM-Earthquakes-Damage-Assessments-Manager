...
function Controller() {
    ...
    $.__views.atc20NZPersonalDataWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.atc20NZPersonalDataWindow.rightNavButton = $.__views.btn_ios_Save;
    ...
    $.__views.navigationWindowATC20NZPD = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.atc20NZPersonalDataWindow,
        id: "navigationWindowATC20NZPD"
    });
    $.__views.navigationWindowATC20NZPD && $.addTopLevelView($.__views.navigationWindowATC20NZPD);
    ...
    try {
        ...
        RegisterHideKeyboard($.atc20NZPersonalDataWindow, [ $.widgetAppTextFieldInspectorID.get_text_field(), $.widgetAppTextFieldAuthority.get_text_field() ]);
