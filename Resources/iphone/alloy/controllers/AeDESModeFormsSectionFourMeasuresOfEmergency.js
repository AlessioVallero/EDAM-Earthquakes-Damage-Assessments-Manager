...
function Controller() {
    ...
    $.__views.aedesModeSectionFourMeasuresOfEmergencyWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowSectionFourMeasuresOfEmergency = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.aedesModeSectionFourMeasuresOfEmergencyWindow,
        id: "navigationWindowSectionFourMeasuresOfEmergency"
    });
    $.__views.navigationWindowSectionFourMeasuresOfEmergency && $.addTopLevelView($.__views.navigationWindowSectionFourMeasuresOfEmergency);
