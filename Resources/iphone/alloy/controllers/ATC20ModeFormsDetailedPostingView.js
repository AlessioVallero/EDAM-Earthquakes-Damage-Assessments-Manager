...
function Controller() {
    ...
    $.__views.atc20ModeDetailedPostingWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowDetailedPosting = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.atc20ModeDetailedPostingWindow,
        id: "navigationWindowDetailedPosting"
    });
    $.__views.navigationWindowDetailedPosting && $.addTopLevelView($.__views.navigationWindowDetailedPosting);
