...
function Controller() {
    ...
    $.__views.btn_login_ios_back = Ti.UI.createButton({
        title: L("generic_back_btn_title"),
        id: "btn_login_ios_back"
    });
    OnBtnBack_Click ? $.__views.btn_login_ios_back.addEventListener("click", OnBtnBack_Click) : __defers["$.__views.btn_login_ios_back!click!OnBtnBack_Click"] = true;
    $.__views.loginWindow.leftNavButton = $.__views.btn_login_ios_back;
    ...
    $.__views.navigationWindowLogin = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.loginWindow,
        id: "navigationWindowLogin"
    });
    $.__views.tabLogin = Ti.UI.createTab({
        title: L("user_authentication_login_view_title"),
        backgroundColor: "#ffffcc",
        icon: "/images/login.png",
        window: $.__views.navigationWindowLogin,
        id: "tabLogin"
    });
    __alloyId173.push($.__views.tabLogin);
    $.__views.registerWindow = Ti.UI.createWindow({
        backgroundColor: "#ffffcc",
        id: "registerWindow"
    });
    $.__views.btn_register_ios_back = Ti.UI.createButton({
        title: L("generic_back_btn_title"),
        id: "btn_register_ios_back"
    });
    OnBtnBack_Click ? $.__views.btn_register_ios_back.addEventListener("click", OnBtnBack_Click) : __defers["$.__views.btn_register_ios_back!click!OnBtnBack_Click"] = true;
    $.__views.registerWindow.leftNavButton = $.__views.btn_register_ios_back;
    ...
    $.__views.navigationWindowRegister = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.registerWindow,
        id: "navigationWindowRegister"
    });
    $.__views.tabRegister = Ti.UI.createTab({
        title: L("user_authentication_register_view_title"),
        backgroundColor: "#ffffcc",
        icon: "/images/register.png",
        window: $.__views.navigationWindowRegister,
        id: "tabRegister"
    });
    __alloyId173.push($.__views.tabRegister);
    ...
    __defers["$.__views.btn_login_ios_back!click!OnBtnBack_Click"] && $.__views.btn_login_ios_back.addEventListener("click", OnBtnBack_Click);
    __defers["$.__views.btn_register_ios_back!click!OnBtnBack_Click"] && $.__views.btn_register_ios_back.addEventListener("click", OnBtnBack_Click);
    _.extend($, exports);
}
