...
function Controller() {
    ...
    $.__views.damageAssessmentsMakerWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowDamageAssessmentsMaker = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.damageAssessmentsMakerWindow,
        id: "navigationWindowDamageAssessmentsMaker"
    });
    $.__views.navigationWindowDamageAssessmentsMaker && $.addTopLevelView($.__views.navigationWindowDamageAssessmentsMaker);
