...
function Controller() {
    ...
    $.__views.shedModeDamageDetailsWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowDamageDetails = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.shedModeDamageDetailsWindow,
        id: "navigationWindowDamageDetails"
    });
    $.__views.navigationWindowDamageDetails && $.addTopLevelView($.__views.navigationWindowDamageDetails);
