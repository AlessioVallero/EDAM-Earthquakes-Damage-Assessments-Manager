...
function Controller() {
    ...
    $.__views.baeaModeFormsTsunamiWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.__alloyId112.add($.__views.lblPhoto);
    ...
    $.__views.navigationWindowTsunami = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeFormsTsunamiWindow,
        id: "navigationWindowTsunami"
    });
    $.__views.navigationWindowTsunami && $.addTopLevelView($.__views.navigationWindowTsunami);
