...
function Controller() {
    ...
    $.__views.shedModeFormsShedPositionWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.scrollViewShedPosition.add($.__views.viewAppButtonSave);
    ...
    $.__views.navigationWindowShedPosition = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.shedModeFormsShedPositionWindow,
        id: "navigationWindowShedPosition"
    });
    $.__views.navigationWindowShedPosition && $.addTopLevelView($.__views.navigationWindowShedPosition);
    ...
    try {
        ...
        RegisterHideKeyboard($.shedModeFormsShedPositionWindow, [ $.widgetAppTextFieldShedModeFormsShedPositionLatitude.get_text_field(), $.widgetAppTextFieldShedModeFormsShedPositionLongitude.get_text_field(), $.widgetAppTextFieldShedModeFormsShedPositionAltitude.get_text_field(), $.widgetAppTextFieldShedModeFormsShedPositionProvince.get_text_field(), $.widgetAppTextFieldShedModeFormsShedPositionMunicipality.get_text_field(), $.widgetAppTextFieldShedModeFormsShedPositionPlace.get_text_field(), $.widgetAppTextFieldShedModeFormsShedPositionAddress.get_text_field(), $.widgetAppTextFieldShedModeFormsShedPositionCivicNo.get_text_field() ]);
