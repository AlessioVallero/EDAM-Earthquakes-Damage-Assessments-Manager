...
function Controller() {
    ...
    $.__views.baeaModeLandslideMaterialTypeWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowLandslideMaterialType = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeLandslideMaterialTypeWindow,
        id: "navigationWindowLandslideMaterialType"
    });
    $.__views.navigationWindowLandslideMaterialType && $.addTopLevelView($.__views.navigationWindowLandslideMaterialType);
