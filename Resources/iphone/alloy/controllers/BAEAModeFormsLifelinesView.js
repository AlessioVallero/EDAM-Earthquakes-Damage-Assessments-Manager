...
function Controller() {
    ...
    $.__views.baeaModeFormsLifelinesWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.__alloyId101.add($.__views.lblPhoto);
    ...
    $.__views.__alloyId103.add($.__views.lblCommunication);
    ...
    $.__views.__alloyId104.add($.__views.lblElectricPowerDelivery);
    ...
    $.__views.__alloyId105.add($.__views.lblOther);
    ...
    $.__views.navigationWindowLifelines = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeFormsLifelinesWindow,
        id: "navigationWindowLifelines"
    });
    $.__views.navigationWindowLifelines && $.addTopLevelView($.__views.navigationWindowLifelines);
