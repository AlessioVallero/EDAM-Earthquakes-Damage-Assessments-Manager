...
function Controller() {
    ...
    $.__views.shedModeFormsGeneralSectionWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.imageViewShedLogo = Ti.UI.createImageView({
        top: 245,
        width: "100%",
        image: "/images/Shed_logo.png",
        id: "imageViewShedLogo"
    });
    $.__views.scrollViewGeneralSection.add($.__views.imageViewShedLogo);
    $.__views.navigationWindowShedModeFormsGeneralSection = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.shedModeFormsGeneralSectionWindow,
        id: "navigationWindowShedModeFormsGeneralSection"
    });
    $.__views.navigationWindowShedModeFormsGeneralSection && $.addTopLevelView($.__views.navigationWindowShedModeFormsGeneralSection);
