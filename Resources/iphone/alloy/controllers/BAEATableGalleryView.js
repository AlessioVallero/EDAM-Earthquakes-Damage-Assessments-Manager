...
function Controller() {
    ...
    $.__views.baeaTableGalleryViewWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowBAEATableGalleryView = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaTableGalleryViewWindow,
        id: "navigationWindowBAEATableGalleryView"
    });
    $.__views.navigationWindowBAEATableGalleryView && $.addTopLevelView($.__views.navigationWindowBAEATableGalleryView);
