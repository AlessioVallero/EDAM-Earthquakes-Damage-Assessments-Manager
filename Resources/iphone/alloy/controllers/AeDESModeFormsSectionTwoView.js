...
function Controller() {
    ...
    $.__views.aedesModeSectionTwoWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowSectionTwo = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.aedesModeSectionTwoWindow,
        id: "navigationWindowSectionTwo"
    });
    $.__views.navigationWindowSectionTwo && $.addTopLevelView($.__views.navigationWindowSectionTwo);
