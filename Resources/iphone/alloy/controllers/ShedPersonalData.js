...
function Controller() {
    ...
    $.__views.shedPersonalDataWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.shedPersonalDataWindow.rightNavButton = $.__views.btn_ios_Save;
    ...
    $.__views.navigationWindowSPD = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.shedPersonalDataWindow,
        id: "navigationWindowSPD"
    });
    $.__views.navigationWindowSPD && $.addTopLevelView($.__views.navigationWindowSPD);
