...
function Controller() {
    ...
    $.__views.atc20ModeDetailedEvaluationGeotechnicalHazardsWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowDetailedEvaluationGeotechnicalHazards = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.atc20ModeDetailedEvaluationGeotechnicalHazardsWindow,
        id: "navigationWindowDetailedEvaluationGeotechnicalHazards"
    });
    $.__views.navigationWindowDetailedEvaluationGeotechnicalHazards && $.addTopLevelView($.__views.navigationWindowDetailedEvaluationGeotechnicalHazards);
