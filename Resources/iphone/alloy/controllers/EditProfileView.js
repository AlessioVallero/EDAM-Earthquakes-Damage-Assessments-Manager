...
function Controller() {
    ...
    $.__views.editProfileWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowEditProfile = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.editProfileWindow,
        id: "navigationWindowEditProfile"
    });
    $.__views.navigationWindowEditProfile && $.addTopLevelView($.__views.navigationWindowEditProfile);
