...
function Controller() {
    ...
    $.__views.shedModeJudgmentOfPracticabilityWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.scrollViewJudgmentOfPracticability.add($.__views.viewAppButtonSave);
    ...
    $.__views.navigationWindowJudgmentOfPracticability = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.shedModeJudgmentOfPracticabilityWindow,
        id: "navigationWindowJudgmentOfPracticability"
    });
    $.__views.navigationWindowJudgmentOfPracticability && $.addTopLevelView($.__views.navigationWindowJudgmentOfPracticability);
    ...
    try {
        ...
        RegisterHideKeyboard($.shedModeJudgmentOfPracticabilityWindow, [ $.widgetAppTextFieldShedModeFormsJudgmentOfPracticabilityHousingUnitsUninhabitable.get_text_field(), $.widgetAppTextFieldShedModeFormsJudgmentOfPracticabilityFamiliesEvacuated.get_text_field(), $.widgetAppTextFieldShedModeFormsJudgmentOfPracticabilityFamiliesEvacuated.get_text_field(), $.widgetAppTextFieldShedModeFormsJudgmentOfPracticabilityOther.get_text_field() ]);
