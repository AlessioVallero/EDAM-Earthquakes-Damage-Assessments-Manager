...
function Controller() {
    ...
    $.__views.aedesModeSectionFourDamagesWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.navigationWindowSectionFourDamages = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.aedesModeSectionFourDamagesWindow,
        id: "navigationWindowSectionFourDamages"
    });
    $.__views.navigationWindowSectionFourDamages && $.addTopLevelView($.__views.navigationWindowSectionFourDamages);
