...
function Controller() {
    ...
    $.__views.teamPersonalDataWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    $.__views.teamPersonalDataWindow.rightNavButton = $.__views.btn_ios_Save;
    ...
    $.__views.navigationWindowTPD = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.teamPersonalDataWindow,
        id: "navigationWindowTPD"
    });
    $.__views.navigationWindowTPD && $.addTopLevelView($.__views.navigationWindowTPD);
    ...
    try {
        ...
        RegisterHideKeyboard($.teamPersonalDataWindow, [ $.widgetAppTextFieldName1.get_text_field(), $.widgetAppTextFieldName2.get_text_field(), $.widgetAppTextFieldName3.get_text_field() ]);
