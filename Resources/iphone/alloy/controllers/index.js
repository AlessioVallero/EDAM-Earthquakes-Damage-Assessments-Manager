...
function Controller() {
    ...
    function OnBtnTools_Click() {
        try {
            ...
            Titanium.Network.networkType === Titanium.Network.NETWORK_NONE ? Alloy.Globals.createAndOpenControllerExt("ToolsView", {
                is_logged: false
                ...
                if (Alloy.Globals.ExistSession()) {
                    ...
                    loader.onload = function() {
                        ...
                        } else Alloy.Globals.createAndOpenControllerExt("ToolsView", {
                            is_logged: true
                        });
                    };
    ...
    $.__views.viewAppButtonHelp = Ti.UI.createView({
        top: "64%",
        left: 3,
        height: 100,
        width: 60,
        id: "viewAppButtonHelp"
    });
    $.__views.mainView.add($.__views.viewAppButtonHelp);
    $.__views.widgetAppButtonHelp = Alloy.createWidget("com.diseg.AppButton", "widget", {
        id: "widgetAppButtonHelp",
        __parentSymbol: $.__views.viewAppButtonHelp
    });
    $.__views.widgetAppButtonHelp.setParent($.__views.viewAppButtonHelp);
