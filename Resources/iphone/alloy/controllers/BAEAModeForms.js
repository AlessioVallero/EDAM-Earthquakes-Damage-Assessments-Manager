...
function Controller() {
    function __alloyId70(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId65 = Ti.UI.createTableViewRow({
                hasChild: "true",
                rowId: "undefined" != typeof __alloyId63.__transform["ID"] ? __alloyId63.__transform["ID"] : __alloyId63.get("ID"),
                isSynchronized: "undefined" != typeof __alloyId63.__transform["SYNCHRONIZED"] ? __alloyId63.__transform["SYNCHRONIZED"] : __alloyId63.get("SYNCHRONIZED"),
                className: "form_row"
            });
            rows.push(__alloyId65);
            var __alloyId66 = Ti.UI.createImageView({
                left: 5,
                width: 34,
                height: 34,
                image: "/images/check.png"
            });
            __alloyId65.add(__alloyId66);
            var __alloyId67 = Ti.UI.createLabel({
                left: 45,
                height: 40,
                width: 200,
                color: "#000",
                text: "undefined" != typeof __alloyId63.__transform["ID"] ? __alloyId63.__transform["ID"] : __alloyId63.get("ID")
            });
    ...
    $.__views.baeaModeFormsWindow.leftNavButton = $.__views.btn_ios_back;
    ...
    var __alloyId69 = Alloy.Collections["BAEAForms"] || BAEAForms;
    ...
    $.__views.navigationWindowBAEAModeForms = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.baeaModeFormsWindow,
        id: "navigationWindowBAEAModeForms"
    });
    $.__views.navigationWindowBAEAModeForms && $.addTopLevelView($.__views.navigationWindowBAEAModeForms);
