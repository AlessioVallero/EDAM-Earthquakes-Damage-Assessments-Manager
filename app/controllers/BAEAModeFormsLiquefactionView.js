...
function Back()
{
    try
    {
        ...
        {
            $.baeaModeFormsLiquefactionWindow.close() ;
        }
    }
    catch( exception )
    {
...
function OnTableViewBAEAModeFormsLiquefactionPhoto_Click( e )
{
    try
    {
            ...
            if( view_enabled )
            {
                ...
                optionDialog.addEventListener( 'click' , function( e )
                {
                    switch( e.index )
                    {
                        ...
                        case 0:
                        {
                            Titanium.Media.showCamera(
                            {
                                success: function( event )
                                {
                                    ...
                                    Alloy.Globals.CurrentTemporaryPicsPath.push( { media: newFile.getNativePath() , section: "LQ" } ) ;
                                } ,
                                cancel: function()
                                {
                        ...
                        case 1:
                        {
                            ...
                            Titanium.Media.openPhotoGallery(
                            {
                                success:function( event )
                                {
                                    ...
                                    // Getting media
                                    var mediaDetails = { media: newFile.getNativePath() , section: "LQ" } ;
                        ...
                        case 2:
                        {
                            Alloy.Globals.createAndOpenControllerExt( 'DraftPaintView' , { type: "Detailed_BAEA_Sketch" , baea_section: "LQ" } ) ;
                        }
                        break ;
...
function OnGeoreserve_Done( formattedAnswer )
{
    ...
    finally
    {
        ...
        if( bViewAddress )
        {
            Alloy.Globals.createAndOpenControllerExt( 'ViewUsersLocations' , { users_coordinates: { 'LATITUDE': $.widgetAppTextFieldBAEAModeFormsLiquefactionLatitude.get_text_value() , 'LONGITUDE': $.widgetAppTextFieldBAEAModeFormsLiquefactionLongitude.get_text_value() } , mode: "YL" } ) ;
...
function OnBtnViewAddress_Click( e )
{
    try
    {
        ...
        {
            if( !$.widgetAppTextFieldBAEAModeFormsLiquefactionLatitude.get_text_value() ||
                !$.widgetAppTextFieldBAEAModeFormsLiquefactionLongitude.get_text_value() )
            {
                bViewAddress = true ;
...
// Sand Blows or Fissures picker change event handler
...
// Ground Settlement picker change event handler
...
// Lateral Spreading picker change event handler
...
function OnBtnRecord_Click( e )
{
    try
    {
        ...
        if( current_global_ar_index != -1 )
        {
            ...
            {
                // Init of the array (if it's necessary)
                if( !Alloy.Globals.BAEAModeLiquefaction[current_global_ar_index]["PHOTOS"] )
                {
                    Alloy.Globals.BAEAModeLiquefaction[current_global_ar_index]["PHOTOS"] = new Array() ;
                }
            ...
            Ti.App.fireEvent( 'baea_mode_manage_section:record_update' , { index: current_global_ar_index , value: Alloy.Globals.BAEAModeLiquefaction[current_global_ar_index]["SITE"] }  ) ;
        }
        else
        {
            ...
            if( Alloy.Globals.BAEAModeLiquefaction.length > 0 )
            {
                Alloy.Globals.BAEAModeLiquefaction.splice( 0 , 0 , newLiquefactionItem ) ;
            }
            else
            {
                Alloy.Globals.BAEAModeLiquefaction.push( newLiquefactionItem ) ;
            }
...
try
{
    ...
    {
        sandBlowsOrFissuresView = $.viewAppComboBoxBAEAModeFormsLiquefactionSandBlowsOrFissures ;
        groundSettlementView = $.viewAppComboBoxBAEAModeFormsLiquefactionGroundSettlement ;
        lateralSpreadingView = $.viewAppComboBoxBAEAModeFormsLiquefactionLateralSpreading ;
    }
    ...
    {
        $.widgetAppComboBoxBAEAModeFormsLiquefactionSandBlowsOrFissures.set_selected_index( "1" ) ; // No
        $.widgetAppComboBoxBAEAModeFormsLiquefactionGroundSettlement.set_selected_index( "1" ) ;    // No
        $.widgetAppComboBoxBAEAModeFormsLiquefactionLateralSpreading.set_selected_index( "1" ) ;    // No
        $.widgetAppTextFieldBAEAModeFormsLiquefactionHorizontal.set_text_value( "0" ) ;             // 0
        $.widgetAppTextFieldBAEAModeFormsLiquefactionVertical.set_text_value( "0" ) ;               // 0
    }

    RegisterHideKeyboard( $.baeaModeFormsLiquefactionWindow ,
    [
        $.widgetAppTextFieldBAEAModeFormsLiquefactionSiteName.get_text_field() ,
        $.widgetAppTextFieldBAEAModeFormsLiquefactionLatitude.get_text_field() ,
        $.widgetAppTextFieldBAEAModeFormsLiquefactionLongitude.get_text_field() ,
        $.widgetAppTextFieldBAEAModeFormsLiquefactionAddress.get_text_field() ,
        $.widgetAppTextFieldBAEAModeFormsLiquefactionHorizontal.get_text_field() ,
        $.widgetAppTextFieldBAEAModeFormsLiquefactionVertical.get_text_field() ,
        $.widgetAppTextFieldBAEAModeFormsLiquefactionNotes.get_text_field()
    ] ) ;
    ...
    {
        $.baeaModeFormsLiquefactionWindow.open() ;
    }
}
catch( exception )
{
